...
//
//     final picking = pickingFromJson(jsonString);

import 'dart:convert';

List<Picking> pickingFromJson(String str) => List<Picking>.from(json.decode(str).map((x) => Picking.fromJson(x)));

String pickingToJson(List<Picking> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
