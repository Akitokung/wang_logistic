...
class SelfPage extends StatefulWidget {
  ...
  State<SelfPage> createState() => _SelfPageState(code);
}
...
class _SelfPageState extends State<SelfPage> {
  ...
  FutureBuilder<List<Self>> _buildNetwork(String code) {
    return FutureBuilder<List<Self>>(
      future: NetworkService().getSelf(code),
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          List<Self>? data = snapshot.data;
  ...
  Widget _buildCardBlock(List<Self> data) {
    return Scrollbar(
      isAlwaysShown: true,
